...
def sanitizer_smoke(harness:pathlib.Path,td:pathlib.Path) -> None:
    ...
    log("[PASS SAN] ASan+UBSan parser harness: PE/ELF/JVM/DEX/Wasm/Hermes/Lua + Unity registration/engine/encoded-method/RGCTX/method-dispatch/generic-class profile malformed/static contracts; static only")
