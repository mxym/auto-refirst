...
struct UnityGenericClassInfo {
    ...
    std::uint64_t va=0,type_va=0,cached_class_va=0,tail_qword=0;
...
struct UnityInfo {
    ...
    std::uint32_t generic_class_count=0,generic_class_unique_struct_count=0,generic_class_duplicate_ref_count=0,generic_class_unique_type_definition_count=0,generic_class_max_argc=0,generic_class_record_size=0;
